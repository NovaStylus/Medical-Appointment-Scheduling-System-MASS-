...
<body>
  ...
  <div class="container-fluid d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex align-items-center gap-3 pe-3">
      ...
      <!-- Notification Bell -->
      <a href="notifictions.php" title="Notifications" style="position: relative; text-decoration: none;">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <h2 class="text-center fw-bold mb-4">Welcome, Admin</h2>

  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">

    <!-- Card -->
    <div class="col">
      <a href="manage_slots.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-calendar-check display-4 mb-3 text-primary"></i>
          <h5 class="fw-semibold">Manage Appointments</h5>
        </div>
      </a>
    </div>
    ...
    <div class="col">
      <a href="view_users.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          ...
          <h5 class="fw-semibold">View Appointments</h5>
        </div>
      </a>
    </div>

    <div class="col">
      <a href="signup_users.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-person-plus display-4 mb-3 text-primary"></i>
          <h5 class="fw-semibold">Registered Users</h5>
        </div>
      </a>
    </div>
    ...
    <div class="col">
      <a href="manage_users.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-person-gear display-4 mb-3 text-primary"></i>
    ...
    <div class="col">
      <a href="view_walk_in.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-person-walking display-4 mb-3 text-primary"></i>
          <h5 class="fw-semibold">Manage Walk-In Patients</h5>
        </div>
      </a>
    </div>

    <div class="col">
      <a href="dep.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-building display-4 mb-3 text-primary"></i>
          <h5 class="fw-semibold">Manage Departments</h5>
        </div>
      </a>
    </div>

    <div class="col">
      <a href="update_admin.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
    ...
    <div class="col">
      <a href="admin_msg.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
          <i class="bi bi-chat-dots display-4 mb-3 text-primary"></i>
          <h5 class="fw-semibold">Messages</h5>
        </div>
      </a>
    </div>

    <div class="col">
      <a href="booking_report.php" class="text-decoration-none text-dark">
        <div class="card h-100 text-center shadow-sm p-3">
