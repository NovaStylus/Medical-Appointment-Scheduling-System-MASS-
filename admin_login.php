    ...
    <div class="form-container">
        <form method="POST" class="login-form">
            ...
            <div class="forgot-password m-3">
             ...
             <div class="signup-prompt d-grid gap-1 col-6 mx-auto m-1">
            <p style="white-space:pre;">Don't have an account?</p>
            <button class="btn btn-lg m-1" style="background-color: #28a745;color:#FFFFFF;"onclick="window.location.href='admin_signup.php'">Sign up</button>
        </div>     
