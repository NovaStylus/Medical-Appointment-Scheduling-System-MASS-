...
if (!isset($_SESSION['receptionist']['id'])) {
    header("Location: rec_login.php");
    exit();
}

$userId = $_SESSION['receptionist']['id'];
$message = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['confirm_delete']) && $_POST['confirm_delete'] === 'yes') {
        ...
        $stmt = $conn->prepare("DELETE FROM receptionist WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            session_destroy();
            header("Location: rec_signup.php?message=Your account has been deleted successfully.");
            exit();
        } else {
        ...
        header("Location: update_rec.php");
        exit();
    }
}
?>
...
<body>
    <div class="container">
        ...
        <form method="post" action="delete_rec_account.php">
